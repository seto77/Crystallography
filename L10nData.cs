...
internal static class L10nData
{
    public static void Populate(System.Collections.Generic.Dictionary<string, L10n.Entry[]> reg)
    {
        ...
        reg["FormDiffractionSimulatorDynamicCompression"] = new L10n.Entry[]
        {
            ...
            new("checkBoxSkipDrawing", "Text", "Skip drawing during execution", "実行中は描画を省略", "Zeichnen bei Ausführung überspringen", "Ignorer le tracé pendant l'exécution", "Omitir el dibujo durante la ejecución", "Pular desenho durante a execução", "Salta il disegno durante l'esecuzione", "Пропускать отрисовку при выполн.", "执行期间跳过绘制", "執行期間略過繪製", "실행 중 그리기 건너뛰기"),
        ...
        reg["FormPolycrystallineDiffractionSimulator"] = new L10n.Entry[]
        {
            ...
            new("groupBoxFittingOptions", "Text", "Fitting option", "フィッティングオプション", "Fit-Option", "Option d'ajust.", "Opción de ajuste", "Opção de ajuste", "Opzioni di fitting", "Парам. подгонки", "拟合选项", "擬合選項", "피팅 옵션"),
